...
const CaxynexusAiStrategies: React.FC = () => {
    const handleDownload = () => {
        // Create PDF content
        const content = `FREEZYTRADINGHUB STRATEGIES
...
ALL THE BEST, SEE YOU AT THE MOON CHAMP!`;
        ...
        link.href = url;
        link.download = 'FREEZYTRADINGHUB STRATEGIES.pdf';
        ...
        <div className='strategy-viewer'>
            ...
            <div className='strategy-viewer__content'>
                <div className='strategy-viewer__document'>
                    <h1 className='strategy-viewer__title'>FREEZYTRADINGHUB STRATEGIES</h1>
...
export default CaxynexusAiStrategies;
